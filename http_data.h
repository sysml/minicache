...
static const char __http_shdr04[] = "HTTP/0.9 500\r\n";
static const char __http_shdr05[] = "HTTP/0.9 501\r\n";
static const char __http_shdr06[] = "HTTP/1.0 200 OK\r\n";
static const char __http_shdr07[] = "HTTP/1.0 400 Bad request\r\n";
static const char __http_shdr08[] = "HTTP/1.0 404 Element not found\r\n";
static const char __http_shdr09[] = "HTTP/1.0 500 Internal server error\r\n";
static const char __http_shdr10[] = "HTTP/1.0 501 Not implemented\r\n";
static const char __http_shdr11[] = "HTTP/1.1 200 OK\r\n";
static const char __http_shdr12[] = "HTTP/1.1 400 Bad request\r\n";
static const char __http_shdr13[] = "HTTP/1.1 404 Element not found\r\n";
static const char __http_shdr14[] = "HTTP/1.1 500 Internal server error\r\n";
static const char __http_shdr15[] = "HTTP/1.1 501 Not implemented\r\n";
static const char __http_shdr16[] = "Content-type: text/plain\r\n";
static const char __http_shdr17[] = "Content-type: text/html\r\n";
static const char __http_shdr18[] = "Content-type: application/octet-stream\r\n";
static const char __http_shdr19[] = "Connection: close\r\n";
...
#define HTTP09_SHDR_500           4 /* 500 Internal server error (HTTP/0.9) */
#define HTTP09_SHDR_501           5 /* 501 Not implemented (HTTP/0.9) */
#define HTTP10_SHDR_OK            6 /* 200 OK (HTTP/1.0) */
#define HTTP10_SHDR_400           7 /* 400 Bad request (HTTP/1.0) */
#define HTTP10_SHDR_404           8 /* 404 Element not found (HTTP/1.0) */
#define HTTP10_SHDR_500           9 /* 500 Internal server error (HTTP/1.0) */
#define HTTP10_SHDR_501          10 /* 501 Not implemented (HTTP/1.0) */
#define HTTP11_SHDR_OK           11 /* 200 OK (HTTP/1.1) */
#define HTTP11_SHDR_400          12 /* 400 Bad request (HTTP/1.1) */
#define HTTP11_SHDR_404          13 /* 404 Element not found (HTTP/1.1) */
#define HTTP11_SHDR_500          14 /* 500 Internal server error (HTTP/1.1) */
#define HTTP11_SHDR_501          15 /* 501 Not implemented (HTTP/1.1) */
#define HTTP_SHDR_PLAIN          16 /* text/plain */
#define HTTP_SHDR_HTML           17 /* text/html */
#define HTTP_SHDR_BINARY         18 /* application/octet-stream */
#define HTTP_SHDR_CONN_CLOSE     19 /* Connection: close */
...
static const char _http_err404p[] = \
	...
	"	</head>\n"
	"	\n"
	"	<body style=\"background-color:#212121; color:#FFFFFF; font-family:'HelveticaNeue-Light','Helvetica Neue Light','Helvetica Neue','Helvetica','Droid Sans','Verdana';\">\n"
